...
function pintarRespuestaMachine(respuesta){
    ...
    for(i=0;i<respuesta.length;i++){
        ...
        myTable+="<td> <button onclick=' actualizarInformacionMachine("+respuesta[i].id+")'>Actualizar Máquina</button>";
        myTable+="<td> <button onclick='borrarMachine("+respuesta[i].id+")'>Borrar Máquina</button>";
        myTable+="</tr>";
    }
    myTable+="</table>";
...
function actualizarInformacionMachine(idElemento){
    ...
    $.ajax({
        ...
        success:function(respuesta){
            ...
            $("#select-category").val("");
            autoInicioMachine();
            alert("se ha Actualizado correctamente la máquina")
        }
    });
...
function borrarMachine(idElemento){
    ...
    $.ajax({
        ...
        success:function(respuesta){
            $("#resultado").empty();
            autoInicioMachine();
            alert("Se ha Eliminado correctamente la máquina")
        }
    });
